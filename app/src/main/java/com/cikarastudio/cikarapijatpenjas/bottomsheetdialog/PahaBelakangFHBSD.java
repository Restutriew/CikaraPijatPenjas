...
public class PahaBelakangFHBSD extends BottomSheetDialogFragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        judulfhbsd.setText("Paha Belakang");
    }

    private ArrayList<Massage> getListMassage() {
        String[] dataTitle = getResources().getStringArray(R.array.data_paha_belakang);
        String[] dataDescription = getResources().getStringArray(R.array.data_description_paha_belakang);
        TypedArray dataPhoto = getResources().obtainTypedArray(R.array.data_photo_paha_belakang);
        TypedArray datavideo = getResources().obtainTypedArray(R.array.data_video_paha_belakang);
