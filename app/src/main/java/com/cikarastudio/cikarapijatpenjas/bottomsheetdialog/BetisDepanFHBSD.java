...
public class BetisDepanFHBSD extends BottomSheetDialogFragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        judulfhbsd.setText("Betis Depan");
    }

    private ArrayList<Massage> getListMassage() {
        String[] dataTitle = getResources().getStringArray(R.array.data_betis_depan);
        String[] dataDescription = getResources().getStringArray(R.array.data_description_betis_depan);
        TypedArray dataPhoto = getResources().obtainTypedArray(R.array.data_photo_betis_depan);
        TypedArray datavideo = getResources().obtainTypedArray(R.array.data_video_betis_depan);
