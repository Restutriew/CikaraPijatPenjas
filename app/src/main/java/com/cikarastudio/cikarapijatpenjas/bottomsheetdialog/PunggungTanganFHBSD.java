...
public class PunggungTanganFHBSD extends BottomSheetDialogFragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        judulfhbsd.setText("Punggung Tangan");
    }

    private ArrayList<Massage> getListMassage() {
        String[] dataTitle = getResources().getStringArray(R.array.data_punggung_tangan);
        String[] dataDescription = getResources().getStringArray(R.array.data_description_punggung_tangan);
        TypedArray dataPhoto = getResources().obtainTypedArray(R.array.data_photo_punggung_tangan);
        TypedArray datavideo = getResources().obtainTypedArray(R.array.data_video_punggung_tangan);
