...
public class LenganAtasBawahFHBSD extends BottomSheetDialogFragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        judulfhbsd.setText("Lengan Atas Bawah");
    }

    private ArrayList<Massage> getListMassage() {
        String[] dataTitle = getResources().getStringArray(R.array.data_lengan_atas_bawah);
        String[] dataDescription = getResources().getStringArray(R.array.data_description_lengan_atas_bawah);
        TypedArray dataPhoto = getResources().obtainTypedArray(R.array.data_photo_lengan_atas_bawah);
        TypedArray datavideo = getResources().obtainTypedArray(R.array.data_video_lengan_atas_bawah);
