...
public class PunggungPinggangFHBSD extends BottomSheetDialogFragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        judulfhbsd.setText("Punggung - Pinggang");
    }

    private ArrayList<Massage> getListMassage() {
        String[] dataTitle = getResources().getStringArray(R.array.data_punggung_pinggang);
        String[] dataDescription = getResources().getStringArray(R.array.data_description_punggung_pinggang);
        TypedArray dataPhoto = getResources().obtainTypedArray(R.array.data_photo_punggung_pinggang);
        TypedArray datavideo = getResources().obtainTypedArray(R.array.data_video_punggung_pinggang);
