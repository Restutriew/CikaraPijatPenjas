...
public class BetisBelakangFHBSD extends BottomSheetDialogFragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        judulfhbsd.setText("Betis Belakang");
    }

    private ArrayList<Massage> getListMassage() {
        String[] dataTitle = getResources().getStringArray(R.array.data_betis_belakang);
        String[] dataDescription = getResources().getStringArray(R.array.data_description_betis_belakang);
        TypedArray dataPhoto = getResources().obtainTypedArray(R.array.data_photo_betis_belakang);
        TypedArray datavideo = getResources().obtainTypedArray(R.array.data_video_betis_belakang);
