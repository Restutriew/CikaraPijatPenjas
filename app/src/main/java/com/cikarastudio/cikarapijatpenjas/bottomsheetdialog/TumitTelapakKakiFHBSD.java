...
public class TumitTelapakKakiFHBSD extends BottomSheetDialogFragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        judulfhbsd.setText("Tumit - Telapak Kaki");
    }

    private ArrayList<Massage> getListMassage() {
        String[] dataTitle = getResources().getStringArray(R.array.data_tumit_telapak_kaki);
        String[] dataDescription = getResources().getStringArray(R.array.data_description_tumit_telapak_kaki);
        TypedArray dataPhoto = getResources().obtainTypedArray(R.array.data_photo_tumit_telapak_kaki);
        TypedArray datavideo = getResources().obtainTypedArray(R.array.data_video_tumit_telapak_kaki);
