...
public class BahuFHBSD extends BottomSheetDialogFragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        judulfhbsd.setText("Bahu");
    }

    private ArrayList<Massage> getListMassage() {
        String[] dataTitle = getResources().getStringArray(R.array.data_bahu);
        String[] dataDescription = getResources().getStringArray(R.array.data_description_bahu);
        TypedArray dataPhoto = getResources().obtainTypedArray(R.array.data_photo_bahu);
        TypedArray datavideo = getResources().obtainTypedArray(R.array.data_video_bahu);
