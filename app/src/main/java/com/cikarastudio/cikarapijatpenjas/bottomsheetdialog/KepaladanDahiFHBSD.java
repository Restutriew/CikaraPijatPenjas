...
public class KepaladanDahiFHBSD extends BottomSheetDialogFragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        judulfhbsd.setText("Kepala dan Dahi");
    }

    private ArrayList<Massage> getListMassage() {
        String[] dataTitle = getResources().getStringArray(R.array.data_kepala_dan_dahi);
        String[] dataDescription = getResources().getStringArray(R.array.data_description_kepala_dan_dahi);
        TypedArray dataPhoto = getResources().obtainTypedArray(R.array.data_photo_kepala_dan_dahi);
        TypedArray datavideo = getResources().obtainTypedArray(R.array.data_video_kepala_dan_dahi);
