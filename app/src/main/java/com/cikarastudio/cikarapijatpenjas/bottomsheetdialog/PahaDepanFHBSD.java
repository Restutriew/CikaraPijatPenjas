...
public class PahaDepanFHBSD extends BottomSheetDialogFragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        judulfhbsd.setText("Paha Depan");
    }

    private ArrayList<Massage> getListMassage() {
        String[] dataTitle = getResources().getStringArray(R.array.data_paha_depan);
        String[] dataDescription = getResources().getStringArray(R.array.data_description_paha_depan);
        TypedArray dataPhoto = getResources().obtainTypedArray(R.array.data_photo_paha_depan);
        TypedArray datavideo = getResources().obtainTypedArray(R.array.data_video_paha_depan);
