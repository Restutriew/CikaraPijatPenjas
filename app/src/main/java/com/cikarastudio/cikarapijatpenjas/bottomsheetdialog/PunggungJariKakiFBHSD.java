...
public class PunggungJariKakiFBHSD extends BottomSheetDialogFragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        judulfhbsd.setText("Punggung dan Jari-Jari Kaki");
    }

    private ArrayList<Massage> getListMassage() {
        String[] dataTitle = getResources().getStringArray(R.array.data_punggung_jari_kaki);
        String[] dataDescription = getResources().getStringArray(R.array.data_description_punggung_jari_kaki);
        TypedArray dataPhoto = getResources().obtainTypedArray(R.array.data_photo_punggung_jari_kaki);
        TypedArray datavideo = getResources().obtainTypedArray(R.array.data_video_punggung_jari_kaki);
