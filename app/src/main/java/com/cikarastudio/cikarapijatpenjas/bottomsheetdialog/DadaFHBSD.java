...
public class DadaFHBSD extends BottomSheetDialogFragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        judulfhbsd.setText("Dada");
    }

    private ArrayList<Massage> getListMassage() {
        String[] dataTitle = getResources().getStringArray(R.array.data_dada);
        String[] dataDescription = getResources().getStringArray(R.array.data_description_dada);
        TypedArray dataPhoto = getResources().obtainTypedArray(R.array.data_photo_dada);
        TypedArray datavideo = getResources().obtainTypedArray(R.array.data_video_dada);
