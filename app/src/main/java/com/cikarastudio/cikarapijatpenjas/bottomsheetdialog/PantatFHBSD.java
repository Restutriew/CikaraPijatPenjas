...
public class PantatFHBSD extends BottomSheetDialogFragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        judulfhbsd.setText("Pantat");
    }

    private ArrayList<Massage> getListMassage() {
        String[] dataTitle = getResources().getStringArray(R.array.data_pantat);
        String[] dataDescription = getResources().getStringArray(R.array.data_description_pantat);
        TypedArray dataPhoto = getResources().obtainTypedArray(R.array.data_photo_pantat);
        TypedArray datavideo = getResources().obtainTypedArray(R.array.data_video_pantat);
