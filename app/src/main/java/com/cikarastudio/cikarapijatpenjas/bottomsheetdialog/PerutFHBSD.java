...
public class PerutFHBSD extends BottomSheetDialogFragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        judulfhbsd.setText("Perut");
    }

    private ArrayList<Massage> getListMassage() {
        String[] dataTitle = getResources().getStringArray(R.array.data_perut);
        String[] dataDescription = getResources().getStringArray(R.array.data_description_perut);
        TypedArray dataPhoto = getResources().obtainTypedArray(R.array.data_photo_perut);
        TypedArray datavideo = getResources().obtainTypedArray(R.array.data_video_perut);
